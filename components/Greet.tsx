...
export default function Greet() {
  ...
  useEffect(() => {
    const checkTodayStatus = () => {
      ...
      const todayPublicHoliday = (dataHolidays as Holiday[]).find(holiday => {
        ...
        holidayDate.setHours(0, 0, 0, 0); // Normalisasi tanggal dari JSON
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center p-8">
        <svg className="h-12 w-12 animate-spin text-slate-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      {/* 7. Mengganti `styles.description` dengan kelas Tailwind */}
